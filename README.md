...
Toolbox
Languages  ·  C#, Java, SQL, JavaScript Backend  ·  ASP.NET Core MVC (.NET 8), Entity Framework Core, ADO.NET, xUnit Cloud  ·  Azure Functions, Azure SQL, Table / Blob / Queue Storage, Azure File Share Data & tooling  ·  SQL Server, Git, Bootstrap 5
